...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '04986c83-6537-46dc-9fa1-1dd271be7c80' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('18616ae5-f328-4168-8495-451633d0c14e');
      cy.get(`[data-cy="name"]`).should('have.value', '18616ae5-f328-4168-8495-451633d0c14e');
